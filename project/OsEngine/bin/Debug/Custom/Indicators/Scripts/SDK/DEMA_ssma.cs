...
{
    public class DEMA_ssma : Aindicator
    {
        ...
        {
            // DEMA(i) = 2*EMA_1(price, length) - EMA_2(EMA_1(price, length), length)
            ...
            _series.Values[index] = 2.0m * _seriesEma1.Values[index] - _seriesEma2.Values[index];
        }
        ...
        private void ProcessEma(IndicatorDataSeries _series, int index, decimal val, IndicatorParameterInt length)
        {
            ...
            else
            {
                ...
                result = (ssmaLast * (length.ValueInt - 1) + val) / length.ValueInt;
            }
