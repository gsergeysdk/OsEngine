...
namespace OsEngine.Robots.Soldiers
{
    [Bot("SDKThreeSoldier")]
    public class SDKThreeSoldier : BotPanel
    {
        public SDKThreeSoldier(string name, StartProgram startProgram)
