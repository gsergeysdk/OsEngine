...
{
    [Bot("SDKFuturesBollinger")]
    public class SDKFuturesBollinger : BotPanel
    {
        BotTabSimple _base1;
        ...
        public SDKFuturesBollinger(string name, StartProgram startProgram) : base(name, startProgram)
        {
            // non trade periods
        ...
        private BotTabSimple GetFuturesToTrade(BotTabSimple baseSource, BotTabScreener futures, DateTime currentTime)
        {
            ...
            */
            ...
            for (int i = 0;i < futures.Tabs.Count;i++)
            {
                ...
                if(daysByExpiration < (double)_closeAtExpirationDays.ValueDecimal
