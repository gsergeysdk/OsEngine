...
{
    [Bot("SDKBollinger2Screener")] // We create an attribute so that we don't write anything to the BotFactory
    public class SDKBollinger2Screener : BotPanel
    {
        ...
        public SDKBollinger2Screener(string name, StartProgram startProgram) : base(name, startProgram)
        {
