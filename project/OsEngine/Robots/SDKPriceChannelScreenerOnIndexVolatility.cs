...
{
    [Bot("SDKPriceChannelScreenerOnIndexVolatility")]
    public class SDKPriceChannelScreenerOnIndexVolatility : BotPanel
    {
    ...
    = IndicatorsFactory.CreateIndicatorByName("VolatilityStagesAW", name + "VolatilityStagesAW", false);
        ...
        {
            return "SDKPriceChannelScreenerOnIndexVolatility";
        }
        ...
        private void CheckSecuritiesRating(List<Candle> candlesIndex)
        {
            ...
            securityRatingData = securityRatingData.GetRange(0, Math.Min(securityRatingData.Count, TopVolumeSecurities.ValueInt));
